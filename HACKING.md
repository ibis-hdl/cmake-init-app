...
hidden if the `app_DEVELOPER_MODE` option is disabled. Enabling this
...
You have a few options to pass `app_DEVELOPER_MODE` to the configure
...
Runs the executable target `app_exe`.
